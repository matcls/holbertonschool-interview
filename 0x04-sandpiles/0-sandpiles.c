 ...
 * none of its cells contains more than 3 grains (stable)
 * @grid1: the first grid of sandpile
 * @grid2: the second grid of sandpile
 */
void sandpiles_sum(int grid1[3][3], int grid2[3][3])
{
	...
	{
		print_sandpile(grid1), topple_sandpile(grid1, grid2);
	}
}
